...
const TransactionsHistory: FC<ITransactionsHistory> = () => {
    ...
    const [sortedTransactions, setSortedTransactions] = useState<ITransactionsHistory[]>([]);
        ...
        <div className={styles.transactionContainer}>
            ...
            <div className={styles.blockHistory}>
                {isLoading ?
                    ...
                    <>
                        {!sortedTransactions.length ? <NothingFound title='Not found' /> :
                            <div>                {sortedTransactions.map((elem) => {
                                return (
